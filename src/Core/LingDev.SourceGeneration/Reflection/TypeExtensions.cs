...
internal static class TypeExtensions
{
    ...
    {
        // Returns true iff Type instance has potential for receiving nullable reference type annotations, i.e. the
        // type is a reference type or contains generic parameters that are reference types.
